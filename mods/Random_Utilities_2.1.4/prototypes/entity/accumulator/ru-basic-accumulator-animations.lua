function basic_accumulator_picture(tint, repeat_count)
  return
  {
    layers =
    {
...
function basic_accumulator_charge()
  return
  {
    layers =
    {
      basic_accumulator_picture({r=178, g=173, b=100}, 24),
      {
...
function basic_accumulator_reflection()
  return
  {
    pictures =
      {
...
function basic_accumulator_discharge()
  return
  {
    layers =
    {
