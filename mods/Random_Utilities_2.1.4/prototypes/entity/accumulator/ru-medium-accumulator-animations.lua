function medium_accumulator_picture(tint, repeat_count)
  return
  {
    layers =
    {
...
function medium_accumulator_charge()
  return
  {
    layers =
    {
      medium_accumulator_picture({r=202, g=154, b=152}, 24),
      {
...
function medium_accumulator_reflection()
  return
  {
    pictures =
      {
...
function medium_accumulator_discharge()
  return
  {
    layers =
    {
