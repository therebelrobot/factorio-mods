...
data:extend({
{
    type = "pump",
    name = "ru-big-pump",
    icons = {{icon = "__base__/graphics/icons/pump.png", tint = {r=132, g=180, b=181}}},
    icon_size = 64, icon_mipmaps = 4,
    flags = {"placeable-neutral", "player-creation"},
    minable = {mining_time = 0.2, result = "ru-big-pump"},
    max_health = 180,
