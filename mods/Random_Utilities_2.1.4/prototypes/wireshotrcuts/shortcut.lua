...
function wire_shortcut(wire_type, tech_unlock)
    return {
        ...
        icon = {
            filename = "__Random_Utilities__/graphics/icons/" .. wire_type .. "-wire-x32.png",
        ...
        disabled_icon = {
            filename = "__Random_Utilities__/graphics/icons/white-wire-x32.png",
            priority = "extra-high-no-scale",
            size = 32,
            scale = 1,
            flags = {"icon"}
        ...
        small_icon = {
            filename = "__Random_Utilities__/graphics/icons/" .. wire_type .. "-wire-x24.png",
            priority = "extra-high-no-scale",
            size = 24,
            scale = 1,
            flags = {"icon"}
        ...
        disabled_small_icon = {
            filename = "__Random_Utilities__/graphics/icons/white-wire-x24.png",
            priority = "extra-high-no-scale",
            size = 24,
            scale = 1,
            flags = {"icon"}
...
data:extend({
    ...
    wire_shortcut("copper", copper_tech_unlock),
    {
        ...
        icon = {
            filename = "__Random_Utilities__/graphics/icons/wire-cutter-x32.png",
            priority = "extra-high-no-scale",
            size = 32,
            scale = 1,
            flags = {"gui-icon"}
        ...
        disabled_icon = {
            filename = "__Random_Utilities__/graphics/icons/wire-cutter-white-x32.png",
            priority = "extra-high-no-scale",
            size = 32,
            scale = 1,
            flags = {"gui-icon"}
        ...
        small_icon = {
            filename = "__Random_Utilities__/graphics/icons/wire-cutter-x24.png",
            priority = "extra-high-no-scale",
            size = 24,
            scale = 1,
            flags = {"gui-icon"}
        ...
        disabled_small_icon = {
            filename = "__Random_Utilities__/graphics/icons/wire-cutter-white-x24.png",
            priority = "extra-high-no-scale",
            size = 24,
            scale = 1,
            flags = {"gui-icon"}
