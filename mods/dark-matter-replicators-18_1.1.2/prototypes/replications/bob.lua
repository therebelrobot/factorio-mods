...
if bobmods.logistics then
	...
	repltech_raw("basic-transport-belt", 0.01)
	repltech_raw("turbo-transport-belt", 0.01)
	repltech_raw("ultimate-transport-belt", 0.01)

	repltech_raw("ru-behemoth-transport-belt", 0.01)
	repltech_raw("ru-behemoth-underground-belt", 0.01)
	repltech_raw("ru-behemoth-loader", 0.01)
	repltech_raw("ru-behemoth-inserter", 0.01)
	repltech_raw("ru-behemoth-lamp", 0.01)
	repltech_raw("ru-behemoth-solar-panel", 0.01)
	repltech_raw("ru-behemoth-substation", 0.01)
	repltech_raw("ru-behemoth-pipe", 0.01)
	repltech_raw("ru-behemoth-pipe-to-ground", 0.01)
	repltech_raw("ru-behemoth-substation", 0.01)
	repltech_raw("ru-behemoth-accumulator", 0.01)
	repltech_raw("ru-behemoth-splitter", 0.01)
	repltech_raw("bob-construction-robot-5", 0.01)
	repltech_raw("bob-logistic-robot-5", 0.01)
	repltech_raw("speed-module-8", 0.01)
	repltech_raw("micro-assembler-6", 0.01)
	repltech_raw("alien-goo", 0.01)
	repltech_raw("crystal-slurry", 0.01)

	repltech_raw("crystal-powder", 0.01)
	repltech_raw("micro-assembler-6", 0.01)
	repltech_raw("rtg", 0.01)
	repltech_raw("rocket-fuel", 0.01)

		
	--Fish
	repltech_raw("alien-fish-1-raw", 0.01)
	repltech_raw("crystal-splinter-blue-cut", 0.01)
	repltech_raw("crystal-splinter-green-cut", 0.01)
	repltech_raw("crystal-splinter-red-cut", 0.01)
	...
	--Robots
	repltech_raw("bob-logistic-robot-2", 0.01)
	repltech_raw("bob-logistic-robot-3", 0.01)
	repltech_raw("bob-logistic-robot-4", 0.01)
	repltech_raw("bob-construction-robot-2", 0.01)
	repltech_raw("bob-construction-robot-3", 0.01)
	repltech_raw("bob-construction-robot-4", 0.01)
